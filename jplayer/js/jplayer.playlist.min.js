...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			listItem+="<span class='wolf-jp-song-url'>";

			if(!media.download){
				if(media.itunes){
					listItem+="<a target='_blank' title='"+WolfJplayer.iTunesText+"' href='"+media.itunes+"' class='itunes'></a>";
				}

				if(media.amazon){
					listItem+="<a target='_blank' title='"+WolfJplayer.amazonText+"' href='"+media.amazon+"' class='amazon'></a>";
				}

				if(media.buy){
					listItem+="<a target='_blank' title='"+WolfJplayer.buyNowText+"' href='"+media.buy+"' class='buy'></a>";
				}
			}

			else{
				listItem+="<a class='free-dl' title='"+WolfJplayer.downloadText+"' target='_blank' href='"+media.download+"'></a>";
